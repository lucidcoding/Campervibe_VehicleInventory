...
class Authentication
{
    public static function checkCookie()
    {
        if(!isset($_COOKIE['auth_cookie']))
        {
            ...
            $state = "af1Efa";
            $nonce = "1";
            //$url = "https://login.microsoftonline.com/0647f417-1bf4-49be-a7d6-27537bec904f/oauth2/authorize?client_id=2d708142-face-4379-bc2d-7ff4bcfe9be2&response_mode=form_post&response_type=code+id_token&scope=openid+profile&state=af1Efa&nonce=1";
